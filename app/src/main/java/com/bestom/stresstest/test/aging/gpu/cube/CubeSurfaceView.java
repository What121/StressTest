...
package com.bestom.stresstest.test.aging.gpu.cube;
 ...
 */
public class CubeSurfaceView extends GLSurfaceView implements Renderer {
    ...
    private float xspeed = 1;                //X Rotation Speed
    private float yspeed = 1;                //Y Rotation Speed
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //Drawing
        gl.glTranslatef(0, 0, z);            //Move z units into the screen
        gl.glScalef(scale, scale, scale);             //Scale the Cube to 80 percent, otherwise it would be too large for the screen
